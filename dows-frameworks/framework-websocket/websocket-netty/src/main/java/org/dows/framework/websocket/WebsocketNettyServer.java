...
public class WebsocketNettyServer implements  WebSocketServer{
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(WebsocketNettyServer.class);
