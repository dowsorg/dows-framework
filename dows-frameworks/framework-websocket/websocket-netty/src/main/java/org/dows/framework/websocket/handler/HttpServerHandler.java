package org.dows.framework.websocket.handler;
...
import org.dows.framework.websocket.WebSocketEndpointConfig;
import org.dows.framework.websocket.WebSocketNettyEndpoint;
...
public class HttpServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    private final WebSocketNettyEndpoint webSocketEndpointServer;
    ...
    public HttpServerHandler(WebSocketNettyEndpoint webSocketEndpointServer, WebSocketEndpointConfig webSocketEndpointConfig, EventExecutorGroup eventExecutorGroup, boolean isCors) {
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        //path match
        String pattern = null;
        Set<WebSocketPathMatcher> pathMatcherSet = webSocketEndpointServer.getPathMatcherSet();
