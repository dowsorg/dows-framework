...
public class WebSocketMethodMapping {
    ...
    public WebSocketMethodMapping(Class<?> webSocketClazz, ApplicationContext context, List<MethodArgumentResolver> resolvers) throws WebSocketException {
        ...
        // Get parser
        beforeHandshakeArgResolvers = getResolvers(beforeHandshakeParameters,resolvers);
        onOpenArgResolvers = getResolvers(onOpenParameters,resolvers);
        onCloseArgResolvers = getResolvers(onCloseParameters,resolvers);
        onMessageArgResolvers = getResolvers(onMessageParameters,resolvers);
        onErrorArgResolvers = getResolvers(onErrorParameters,resolvers);
        onBinaryArgResolvers = getResolvers(onBinaryParameters,resolvers);
        onEventArgResolvers = getResolvers(onEventParameters,resolvers);
    }
     ...
     */
    private MethodArgumentResolver[] getResolvers(MethodParameter[] parameters,List<MethodArgumentResolver> resolvers) throws WebSocketException {
