...
import org.dows.sequence.snowflake.config.SnowflakeConfig;
...
public class SnowflakeIdGenerator implements IdGenerator {
    ...
    public String generate(String module, String prefix) {
        log.info("Snowflake开始生成Sequence,前缀:{}", prefix);
        String seq = String.format("%s_", prefix) + nextId();
        log.info("Snowflake生成Sequence结束:{}", seq);
        return seq;
    }
    ...
    @Override
    public String generateId(String prefix, IdKey idKey) {
        return null;
    }
